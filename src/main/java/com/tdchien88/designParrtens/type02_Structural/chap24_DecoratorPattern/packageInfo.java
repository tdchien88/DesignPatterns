 ...
 * It is used:
 * 
 * _ When you want to transparently and dynamically add responsibilities to
 * objects without affecting other objects.
 * 
 * _ When you want to add responsibilities to an object that you may want to
 * change in future.
 * 
 * _ Extending functionality by sub-classing is no longer practical.
 * 
 */
